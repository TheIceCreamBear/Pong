...
public class ExistingAccountException extends Exception {
	...
	private static final long serialVersionUID = 8103911375820131016L;
     ...
     * @since 1.7
     */
    protected ExistingAccountException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
